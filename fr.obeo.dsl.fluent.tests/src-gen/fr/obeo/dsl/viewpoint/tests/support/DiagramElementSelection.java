...
public class DiagramElementSelection {
	...
	public fr.obeo.dsl.viewpoint.tests.support.DiagramElementSelection findBorderNode(
			java.lang.String partialName) {
		this.partialName = partialName;
		return this;
	}

	public fr.obeo.dsl.viewpoint.tests.support.DiagramElementSelection editLabel(
			java.lang.String partialName) {
		this.partialName = partialName;
		return this;
	}
	...
	public fr.obeo.dsl.viewpoint.tests.support.DiagramElementSelection dragTo(
