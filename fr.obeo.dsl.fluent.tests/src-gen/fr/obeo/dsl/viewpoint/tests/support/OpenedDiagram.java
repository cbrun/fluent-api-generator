      ...
      public class OpenedDiagram{
            ...
            public OpenedDiagram(DesignerBotContextData ctx) {
            	this.ctx = ctx;
                  ...
                  public fr.obeo.dsl.viewpoint.tests.support.DiagramElementSelection findDiagramElement( java.lang.String partialName ) {
                    	this.partialName = partialName; 
                  	    return ctx.createDiagramElementSelection();
                  }      	
                  
                  public fr.obeo.dsl.viewpoint.tests.support.DiagramElementSelection findDiagramElement( org.eclipse.emf.common.util.URI targetElement ) {
