      ...
      public class OpenedSession{
            ...
            public OpenedSession(DesignerBotContextData ctx) {
            	this.ctx = ctx;
                  ...
                  public fr.obeo.dsl.viewpoint.tests.support.OpenedSession addSemanticResource( org.eclipse.emf.common.util.URI newResourceURI ) {
                    	this.newResourceURI = newResourceURI; 
                  	return this;
                  }      	
                  
                  public fr.obeo.dsl.viewpoint.tests.support.SelectedSemanticResource selectSemanticResource( java.lang.String partialName ) {
