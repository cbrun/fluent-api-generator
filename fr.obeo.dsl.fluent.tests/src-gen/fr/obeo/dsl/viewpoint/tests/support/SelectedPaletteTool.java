...
public class SelectedPaletteTool {
	...
	public fr.obeo.dsl.viewpoint.tests.support.DiagramElementSelection clickOn(
			org.eclipse.gmf.runtime.diagram.ui.editparts.IGraphicalEditPart editPart) {
		this.editPart = editPart;
		return ctx.createDiagramElementSelection();
	}

	public fr.obeo.dsl.viewpoint.tests.support.DiagramElementSelection clickBetween(
			org.eclipse.gmf.runtime.diagram.ui.editparts.IGraphicalEditPart source,
			org.eclipse.gmf.runtime.diagram.ui.editparts.IGraphicalEditPart target) {
		this.source = source;
		this.target = target;
		return ctx.createDiagramElementSelection();
	}
