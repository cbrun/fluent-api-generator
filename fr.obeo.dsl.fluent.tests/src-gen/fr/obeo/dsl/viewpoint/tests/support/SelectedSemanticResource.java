...
public class SelectedSemanticResource {
	...
	public SelectedSemanticResource(DesignerBotContextData ctx,
			org.eclipse.emf.common.util.URI id) {
		this.ctx = ctx;
		this.id = id;
	}
	...
	public fr.obeo.dsl.viewpoint.tests.support.SelectedSemanticObject selectObject(
