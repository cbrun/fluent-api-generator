...
public class ViewpointSelection {
	...
	public fr.obeo.dsl.viewpoint.tests.support.SelectedViewpoint enable(
			java.lang.String viewpointName) {
		this.viewpointName = viewpointName;
		return ctx.createSelectedViewpoint();
	}

	public fr.obeo.dsl.viewpoint.tests.support.SelectedViewpoint disable(
			java.lang.String viewpointName) {
		this.viewpointName = viewpointName;
		return ctx.createSelectedViewpoint();
	}
