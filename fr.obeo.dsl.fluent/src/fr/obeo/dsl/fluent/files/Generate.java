...
public class Generate extends AbstractAcceleoGenerator {
	...
	public void doGenerate(Monitor monitor) throws IOException {
		...
		final CodeFormatter codeStyle = ToolFactory
				.createCodeFormatter(Collections.EMPTY_MAP);
		JavaFormatter jFormat = new JavaFormatter(codeStyle);
		try {
			jFormat.format(targetFolder);
